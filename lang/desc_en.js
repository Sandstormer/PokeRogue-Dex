...
['Powers up moves that make direct contact.','Damage of those moves is boosted by 30%.'],
...
['Boosts the Pokémon’s evasiveness in a sandstorm.','Accuracy of opposing moves is reduced by 20%.'],
...
["The target is jabbed repeatedly with a horn or beak two to five times in a row.","Odds for number of hits are 35%/35%/15%/15%."],
...
["Sharp spikes are shot at the target in rapid succession. They hit two to five times in a row.","Odds for number of hits are 35%/35%/15%/15%."],
...
["The target is raked with sharp claws or scythes quickly two to five times in a row.","Odds for number of hits are 35%/35%/15%/15%."],
...
["The user opens up a fissure in the ground and drops the target in. The target faints instantly if this attack hits.","Accuracy scales up to 100 when the user is 3.33x the target's level. Accuracy can't be modified by other means, except No Guard."],
...
["The user hurls hard rocks at the target. Two to five rocks are launched in a row.","Odds for number of hits are 35%/35%/15%/15%."],
...
["The target faints instantly. It’s less likely to hit the target if it’s used by Pokémon other than Ice types.","Accuracy scales up to 100 when the user is 5x the target's level. Accuracy is increased by 10 for Ice-type users. Accuracy can't be modified by other means, except No Guard."],
...
["The user launches sharp icicles at the target two to five times in a row.","Odds for number of hits are 35%/35%/15%/15%."],
...
["A vicious, tearing attack with big pincers. The target faints instantly if this attack hits.","Accuracy scales up to 100 when the user is 3.33x the target's level. Accuracy can't be modified by other means, except No Guard."],
...
["Round objects are hurled at the target to strike two to five times in a row.","Odds for number of hits are 35%/35%/15%/15%."],
["The user forcefully shoots seeds at the target two to five times in a row.","Odds for number of hits are 35%/35%/15%/15%."],
["The user slams its rugged body into the target to attack. This also damages the user quite a lot.",""],
["The user strikes the target with a hard bone two to five times in a row.","Odds for number of hits are 35%/35%/15%/15%."],
...
["The target is hit with a flurry of punches that strike two to five times in a row.","Odds for number of hits are 35%/35%/15%/15%."],
...
["The user stabs the target with a horn that rotates like a drill. The target faints instantly if this attack hits.","Accuracy scales up to 100 when the user is 3.33x the target's level. Accuracy can't be modified by other means, except No Guard."],
...
["The user lets loose a flurry of open-palmed arm thrusts that hit two to five times in a row.","Odds for number of hits are 35%/35%/15%/15%."],
...
["The user attacks by striking the target with its hard tail. It hits the target two to five times in a row.","Odds for number of hits are 35%/35%/15%/15%."],
...
["The user hits the target with throwing stars two to five times in a row. This move always goes first.","Odds for number of hits are 35%/35%/15%/15%."],
...
["The user attacks by shooting scales two to five times in a row. This move boosts the user’s Speed stat but lowers its Defense stat.","Odds for number of hits are 35%/35%/15%/15%."],
